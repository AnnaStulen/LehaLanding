...
Блок 12 удален из плана, FAQ не делаем.
...
Перед блоком 7 можно сделать правку блока 6:

`Делаем правки для блока 6: Практико-ориентированная модель обучения`

Идея правки: оживить пустую левую область возле 01-07 вертикальной data/motion-анимацией.
